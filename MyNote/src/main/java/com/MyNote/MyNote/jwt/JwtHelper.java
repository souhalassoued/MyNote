...
public class JwtHelper {
    ...
    public String generateAccessToken(Employe Employe) {
        return JWT.create()
                .withIssuer(issuer)
                .withSubject(Employe.getId())
                .withIssuedAt(new Date())
                .withExpiresAt(new Date(new Date().getTime() + accessTokenExpirationMs))
                .sign(accessTokenAlgorithm);
    }

    public String generateRefreshToken(Employe Employe, RefreshToken refreshToken) {
        return JWT.create()
                .withIssuer(issuer)
                .withSubject(Employe.getId())
