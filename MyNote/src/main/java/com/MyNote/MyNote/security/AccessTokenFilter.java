package com.MyNote.MyNote.security;
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        try {
            ...
            if(accessToken.isPresent() && jwtHelper.validateAccessToken(accessToken.get())) {
                ...
                Employe Employe = MyNoteService.findById(userId);
                UsernamePasswordAuthenticationToken upat = new UsernamePasswordAuthenticationToken(Employe, null, Employe.getAuthorities());
